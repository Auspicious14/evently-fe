            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters({ category: e.target.value as Category | "" })
                  }
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {Array.isArray(events) &&
              events.map((event) => {
                const isUpvoted =
                  upvotedEvents[event._id] ?? event.hasUpvoted ?? false;
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={
                        hasImage && event?.imageUrls
                          ? getHeaderStyle(event.imageUrls[0])
                          : {}
                      }
                    >
                      {hasImage && (
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <button
                          onClick={() =>
                            handleUpvoteToggle(event._id, isUpvoted)
                          }
                          disabled={isUpvoting}
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            className="h-9 w-9"
                            onClick={() =>
                              setShareModalOpen({ show: true, _id: event._id })
                            }
                          >
